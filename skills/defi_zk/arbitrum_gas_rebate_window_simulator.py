...
TOOL_META: dict[str, Any] = {
    "name": "arbitrum_gas_rebate_window_simulator",
...
def arbitrum_gas_rebate_window_simulator(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        predicted_fee = 0.080000 * (1 + pressure_index * 0.290)
        ...
        _log_lesson("arbitrum_gas_rebate_window_simulator", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
