---
skill: optimism_tx_priority_curve_optimizer
category: defi_zk
...
# Optimism Tx Priority Curve Optimizer
...
```json
{
  "tool": "optimism_tx_priority_curve_optimizer",
  "arguments": {
    "sequencer_backlog": 0,
...
## Usage
Invoke via `snowdrop_execute` with `tool_name: "optimism_tx_priority_curve_optimizer"`.
