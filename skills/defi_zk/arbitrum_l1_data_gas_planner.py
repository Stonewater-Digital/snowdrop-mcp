"""Optimizes Arbitrum data gas budgeting for the next submission window."""
...
TOOL_META: dict[str, Any] = {
    "name": "arbitrum_l1_data_gas_planner",
    "description": "Optimizes Arbitrum data gas budgeting for the next submission window.",
    "tier": "free",
    "inputSchema": {
    "type": "object",
    "properties": {
...
def arbitrum_l1_data_gas_planner(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        predicted_fee = 0.080000 * (1 + pressure_index * 0.280)
        ...
        _log_lesson("arbitrum_l1_data_gas_planner", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
