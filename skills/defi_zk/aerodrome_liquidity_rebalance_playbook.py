"""Builds Aerodrome liquidity rebalance plans for yield rotations."""
...
TOOL_META: dict[str, Any] = {
    "name": "aerodrome_liquidity_rebalance_playbook",
    "description": "Builds Aerodrome liquidity rebalance plans for yield rotations.",
    "tier": "free",
    "inputSchema": {
    "type": "object",
    "properties": {
...
def aerodrome_liquidity_rebalance_playbook(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        _log_lesson("aerodrome_liquidity_rebalance_playbook", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
