"""Models Pendle LSD leverage spreads with health-factor guardrails."""
...
TOOL_META: dict[str, Any] = {
    "name": "pendle_lsd_leverage_spread_modeler",
    "description": "Models Pendle LSD leverage spreads with health-factor guardrails.",
    "tier": "free",
    "inputSchema": {
    "type": "object",
    "properties": {
...
def pendle_lsd_leverage_spread_modeler(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        il_floor = max(0.0, volatility - 0.320) * 100
        ...
        _log_lesson("pendle_lsd_leverage_spread_modeler", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
