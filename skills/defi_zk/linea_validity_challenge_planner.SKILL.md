---
skill: linea_validity_challenge_planner
category: defi_zk
...
# Linea Validity Challenge Planner
...
```json
{
  "tool": "linea_validity_challenge_planner",
  "arguments": {
...
## Usage
Invoke via `snowdrop_execute` with `tool_name: "linea_validity_challenge_planner"`.
