...
TOOL_META: dict[str, Any] = {
    "name": "optimism_priority_fee_shaper",
...
def optimism_priority_fee_shaper(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        risk_score = (pressure * 0.5 + slippage / 50 + alerts / 20) * 1.030
        ...
        _log_lesson("optimism_priority_fee_shaper", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
