---
skill: optimism_proof_window_reliability_scanner
category: defi_zk
...
# Optimism Proof Window Reliability Scanner
...
```json
{
  "tool": "optimism_proof_window_reliability_scanner",
  "arguments": {
    "sequencer_backlog": 0,
...
## Usage
Invoke via `snowdrop_execute` with `tool_name: "optimism_proof_window_reliability_scanner"`.
