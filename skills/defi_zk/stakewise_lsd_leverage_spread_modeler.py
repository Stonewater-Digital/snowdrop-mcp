"""Models StakeWise LSD leverage spreads with health-factor guardrails."""
...
TOOL_META: dict[str, Any] = {
    "name": "stakewise_lsd_leverage_spread_modeler",
    "description": "Models StakeWise LSD leverage spreads with health-factor guardrails.",
    "tier": "free",
    "inputSchema": {
    "type": "object",
    "properties": {
...
def stakewise_lsd_leverage_spread_modeler(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        il_floor = max(0.0, volatility - 0.180) * 100
        ...
        _log_lesson("stakewise_lsd_leverage_spread_modeler", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
