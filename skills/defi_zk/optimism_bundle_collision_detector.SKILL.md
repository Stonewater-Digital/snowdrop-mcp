---
skill: optimism_bundle_collision_detector
category: defi_zk
...
# Optimism Bundle Collision Detector
...
```json
{
  "tool": "optimism_bundle_collision_detector",
  "arguments": {
...
## Usage
Invoke via `snowdrop_execute` with `tool_name: "optimism_bundle_collision_detector"`.
