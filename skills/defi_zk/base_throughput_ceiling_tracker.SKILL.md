---
skill: base_throughput_ceiling_tracker
category: defi_zk
...
# Base Throughput Ceiling Tracker
...
```json
{
  "tool": "base_throughput_ceiling_tracker",
  "arguments": {
    "sequencer_backlog": 0,
...
## Usage
Invoke via `snowdrop_execute` with `tool_name: "base_throughput_ceiling_tracker"`.
