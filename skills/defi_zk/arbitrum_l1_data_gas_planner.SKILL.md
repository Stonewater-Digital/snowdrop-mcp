---
skill: arbitrum_l1_data_gas_planner
category: defi_zk
...
```json
{
  "tool": "arbitrum_l1_data_gas_planner",
  "arguments": {
    "sequencer_backlog": 0,
...
## Usage
Invoke via `snowdrop_execute` with `tool_name: "arbitrum_l1_data_gas_planner"`.
