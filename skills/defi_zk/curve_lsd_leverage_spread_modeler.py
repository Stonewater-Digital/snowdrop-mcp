...
TOOL_META: dict[str, Any] = {
    "name": "curve_lsd_leverage_spread_modeler",
...
def curve_lsd_leverage_spread_modeler(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        _log_lesson("curve_lsd_leverage_spread_modeler", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
