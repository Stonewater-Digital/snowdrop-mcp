...
TOOL_META: dict[str, Any] = {
    "name": "arbitrum_block_builder_watch",
...
def arbitrum_block_builder_watch(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        risk_score = (pressure * 0.5 + slippage / 50 + alerts / 20) * 0.950
        ...
        _log_lesson("arbitrum_block_builder_watch", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
