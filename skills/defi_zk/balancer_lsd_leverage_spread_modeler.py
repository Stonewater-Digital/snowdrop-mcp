"""Models Balancer LSD leverage spreads with health-factor guardrails."""
...
TOOL_META: dict[str, Any] = {
    "name": "balancer_lsd_leverage_spread_modeler",
    "description": "Models Balancer LSD leverage spreads with health-factor guardrails.",
    "tier": "free",
    "inputSchema": {
    "type": "object",
    "properties": {
...
def balancer_lsd_leverage_spread_modeler(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        il_floor = max(0.0, volatility - 0.250) * 100
        ...
        _log_lesson("balancer_lsd_leverage_spread_modeler", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
