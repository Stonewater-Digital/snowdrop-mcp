"""Simulates Optimism gas rebate windows to recommend timing-sensitive swaps."""
...
TOOL_META: dict[str, Any] = {
    "name": "optimism_gas_rebate_window_simulator",
    "description": "Simulates Optimism gas rebate windows to recommend timing-sensitive swaps.",
    "tier": "free",
    "inputSchema": {
    "type": "object",
    "properties": {
...
def optimism_gas_rebate_window_simulator(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        predicted_fee = 0.070000 * (1 + pressure_index * 0.290)
        ...
        _log_lesson("optimism_gas_rebate_window_simulator", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
