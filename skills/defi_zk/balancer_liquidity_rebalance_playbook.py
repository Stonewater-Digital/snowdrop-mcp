"""Builds Balancer liquidity rebalance plans for yield rotations."""
...
TOOL_META: dict[str, Any] = {
    "name": "balancer_liquidity_rebalance_playbook",
    "description": "Builds Balancer liquidity rebalance plans for yield rotations.",
    "tier": "free",
    "inputSchema": {
    "type": "object",
    "properties": {
...
def balancer_liquidity_rebalance_playbook(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        _log_lesson("balancer_liquidity_rebalance_playbook", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
