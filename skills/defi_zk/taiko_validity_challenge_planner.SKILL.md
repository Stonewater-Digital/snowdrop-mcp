---
skill: taiko_validity_challenge_planner
category: defi_zk
...
# Taiko Validity Challenge Planner
...
```json
{
  "tool": "taiko_validity_challenge_planner",
  "arguments": {
...
## Usage
Invoke via `snowdrop_execute` with `tool_name: "taiko_validity_challenge_planner"`.
