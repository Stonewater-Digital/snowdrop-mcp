...
TOOL_META: dict[str, Any] = {
    "name": "base_proof_window_reliability_scanner",
...
def base_proof_window_reliability_scanner(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        predicted_fee = 0.050000 * (1 + pressure_index * 0.340)
        ...
        _log_lesson("base_proof_window_reliability_scanner", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
