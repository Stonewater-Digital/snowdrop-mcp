...
TOOL_META: dict[str, Any] = {
    "name": "base_priority_lane_optimizer",
...
def base_priority_lane_optimizer(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        risk_score = (pressure * 0.5 + slippage / 50 + alerts / 20) * 0.900
        ...
        _log_lesson("base_priority_lane_optimizer", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
