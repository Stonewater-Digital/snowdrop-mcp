...
TOOL_META: dict[str, Any] = {
    "name": "optimism_jit_liquidity_monitor",
...
def optimism_jit_liquidity_monitor(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        risk_score = (pressure * 0.5 + slippage / 50 + alerts / 20) * 1.080
        ...
        _log_lesson("optimism_jit_liquidity_monitor", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
