---
skill: arbitrum_throughput_ceiling_tracker
category: defi_zk
...
# Arbitrum Throughput Ceiling Tracker
...
```json
{
  "tool": "arbitrum_throughput_ceiling_tracker",
  "arguments": {
    "sequencer_backlog": 0,
...
## Usage
Invoke via `snowdrop_execute` with `tool_name: "arbitrum_throughput_ceiling_tracker"`.
