"""Models Aerodrome LSD leverage spreads with health-factor guardrails."""
...
TOOL_META: dict[str, Any] = {
    "name": "aerodrome_lsd_leverage_spread_modeler",
    "description": "Models Aerodrome LSD leverage spreads with health-factor guardrails.",
    "tier": "free",
    "inputSchema": {
    "type": "object",
    "properties": {
...
def aerodrome_lsd_leverage_spread_modeler(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        il_floor = max(0.0, volatility - 0.280) * 100
        ...
        _log_lesson("aerodrome_lsd_leverage_spread_modeler", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
