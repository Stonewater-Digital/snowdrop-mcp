"""Scores Base mempool congestion risk and suggests throttle actions for spiky bursts."""
...
TOOL_META: dict[str, Any] = {
    "name": "base_mempool_backlog_risk_monitor",
    "description": "Scores Base mempool congestion risk and suggests throttle actions for spiky bursts.",
    "tier": "free",
    "inputSchema": {
    "type": "object",
    "properties": {
...
def base_mempool_backlog_risk_monitor(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        predicted_fee = 0.050000 * (1 + pressure_index * 0.350)
        ...
        _log_lesson("base_mempool_backlog_risk_monitor", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
