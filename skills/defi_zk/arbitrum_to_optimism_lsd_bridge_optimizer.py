"""Optimizes liquid staking derivative bridge routing from Arbitrum to Optimism with fee and latency heuristics."""
...
TOOL_META: dict[str, Any] = {
    "name": "arbitrum_to_optimism_lsd_bridge_optimizer",
    "description": "Optimizes liquid staking derivative bridge routing from Arbitrum to Optimism with fee and latency heuristics.",
    "tier": "free",
    "inputSchema": {
    "type": "object",
    "properties": {
...
def arbitrum_to_optimism_lsd_bridge_optimizer(metrics: Mapping[str, float | int | str]) -> dict[str, Any]:
    """Route liquid staking derivative transfers from Arbitrum to Optimism."""
    ...
    try:
        ...
        _log_lesson("arbitrum_to_optimism_lsd_bridge_optimizer", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
