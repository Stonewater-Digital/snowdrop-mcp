...
TOOL_META: dict[str, Any] = {
    "name": "arbitrum_to_optimism_stablecoin_bridge_optimizer",
...
def arbitrum_to_optimism_stablecoin_bridge_optimizer(metrics: Mapping[str, float | int | str]) -> dict[str, Any]:
    """Route stablecoin transfers from Arbitrum to Optimism."""
    ...
    try:
        ...
        _log_lesson("arbitrum_to_optimism_stablecoin_bridge_optimizer", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
