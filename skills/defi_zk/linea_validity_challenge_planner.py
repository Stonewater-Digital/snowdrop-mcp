"""Plans Linea validity challenge playbooks if proofs degrade."""
...
TOOL_META: dict[str, Any] = {
    "name": "linea_validity_challenge_planner",
    "description": "Plans Linea validity challenge playbooks if proofs degrade.",
    "tier": "free",
    "inputSchema": {
    "type": "object",
    "properties": {
...
def linea_validity_challenge_planner(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        latency_score = (interval / max(15.000, 0.1)) * 0.550
        cost_pressure = (gas_price / 35.0) * 0.3
        privacy_signal = (0.840 + 0.220) / 2
        ...
        _log_lesson("linea_validity_challenge_planner", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
