---
skill: base_latency_breaker_detector
category: defi_zk
...
```json
{
  "tool": "base_latency_breaker_detector",
  "arguments": {
    "sequencer_backlog": 0,
...
## Usage
Invoke via `snowdrop_execute` with `tool_name: "base_latency_breaker_detector"`.
