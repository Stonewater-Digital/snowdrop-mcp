...
TOOL_META: dict[str, Any] = {
    "name": "base_cross_domain_bundle_guard",
...
def base_cross_domain_bundle_guard(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    """Estimate MEV pressure for Base."""
    ...
    try:
        ...
        risk_score = (pressure * 0.5 + slippage / 50 + alerts / 20) * 1.150
        ...
        _log_lesson("base_cross_domain_bundle_guard", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
