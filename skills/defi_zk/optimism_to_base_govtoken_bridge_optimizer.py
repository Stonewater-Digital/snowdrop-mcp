...
TOOL_META: dict[str, Any] = {
    "name": "optimism_to_base_govtoken_bridge_optimizer",
...
def optimism_to_base_govtoken_bridge_optimizer(metrics: Mapping[str, float | int | str]) -> dict[str, Any]:
    """Route governance token transfers from Optimism to Base."""
    ...
    try:
        ...
        _log_lesson("optimism_to_base_govtoken_bridge_optimizer", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
