---
skill: optimism_cross_domain_message_flow_tracker
category: defi_zk
...
# Optimism Cross Domain Message Flow Tracker
...
```json
{
  "tool": "optimism_cross_domain_message_flow_tracker",
  "arguments": {
    "sequencer_backlog": 0,
...
## Usage
Invoke via `snowdrop_execute` with `tool_name: "optimism_cross_domain_message_flow_tracker"`.
