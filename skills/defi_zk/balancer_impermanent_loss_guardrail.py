"""Simulates Balancer IL exposure for dual-asset pools and recommends caps."""
...
# Balancer uses multi-asset weighted pools; fee income buffers moderate volatility but the
# asymmetric pool weights reduce IL protection compared to 50/50 concentrated AMMs.
_IL_VOLATILITY_THRESHOLD: float = 0.250

TOOL_META: dict[str, Any] = {
    "name": "balancer_impermanent_loss_guardrail",
    "description": "Simulates Balancer IL exposure for dual-asset pools and recommends caps.",
    "tier": "free",
    "inputSchema": {
    "type": "object",
    "properties": {
...
def balancer_impermanent_loss_guardrail(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    """Simulate Balancer yield scenarios."""
    ...
    try:
        ...
        _log_lesson("balancer_impermanent_loss_guardrail", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
