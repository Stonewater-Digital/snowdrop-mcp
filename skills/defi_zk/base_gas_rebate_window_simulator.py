"""Simulates Base gas rebate windows to recommend timing-sensitive swaps."""
...
TOOL_META: dict[str, Any] = {
    "name": "base_gas_rebate_window_simulator",
    "description": "Simulates Base gas rebate windows to recommend timing-sensitive swaps.",
    "tier": "free",
    "inputSchema": {
    "type": "object",
    "properties": {
...
def base_gas_rebate_window_simulator(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        predicted_fee = 0.050000 * (1 + pressure_index * 0.290)
        ...
        _log_lesson("base_gas_rebate_window_simulator", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
