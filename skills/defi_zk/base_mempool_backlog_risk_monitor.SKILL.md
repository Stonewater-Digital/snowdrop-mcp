---
skill: base_mempool_backlog_risk_monitor
category: defi_zk
...
# Base Mempool Backlog Risk Monitor
...
```json
{
  "tool": "base_mempool_backlog_risk_monitor",
  "arguments": {
    "sequencer_backlog": 0,
...
## Usage
Invoke via `snowdrop_execute` with `tool_name: "base_mempool_backlog_risk_monitor"`.
