"""Simulates Aerodrome IL exposure for dual-asset pools and recommends caps."""
...
# Aerodrome (Base AMM) uses concentrated liquidity and earns above-average fee income, allowing
# a moderately high threshold before IL materially erodes LP returns.
_IL_VOLATILITY_THRESHOLD: float = 0.280

TOOL_META: dict[str, Any] = {
    "name": "aerodrome_impermanent_loss_guardrail",
    "description": "Simulates Aerodrome IL exposure for dual-asset pools and recommends caps.",
    "tier": "free",
    "inputSchema": {
    "type": "object",
    "properties": {
...
def aerodrome_impermanent_loss_guardrail(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    """Simulate Aerodrome yield scenarios."""
    ...
    try:
        ...
        _log_lesson("aerodrome_impermanent_loss_guardrail", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
