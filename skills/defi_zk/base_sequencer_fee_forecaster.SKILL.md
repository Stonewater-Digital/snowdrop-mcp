---
skill: base_sequencer_fee_forecaster
category: defi_zk
...
```json
{
  "tool": "base_sequencer_fee_forecaster",
  "arguments": {
    "sequencer_backlog": 0,
...
## Usage
Invoke via `snowdrop_execute` with `tool_name: "base_sequencer_fee_forecaster"`.
