---
skill: arbitrum_latency_breaker_detector
category: defi_zk
...
# Arbitrum Latency Breaker Detector
...
```json
{
  "tool": "arbitrum_latency_breaker_detector",
  "arguments": {
    "sequencer_backlog": 0,
...
## Usage
Invoke via `snowdrop_execute` with `tool_name: "arbitrum_latency_breaker_detector"`.
