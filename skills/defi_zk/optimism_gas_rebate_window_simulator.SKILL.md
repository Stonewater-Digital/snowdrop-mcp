---
skill: optimism_gas_rebate_window_simulator
category: defi_zk
...
# Optimism Gas Rebate Window Simulator
...
```json
{
  "tool": "optimism_gas_rebate_window_simulator",
  "arguments": {
    "sequencer_backlog": 0,
...
## Usage
Invoke via `snowdrop_execute` with `tool_name: "optimism_gas_rebate_window_simulator"`.
