"""Builds StakeWise liquidity rebalance plans for yield rotations."""
...
TOOL_META: dict[str, Any] = {
    "name": "stakewise_liquidity_rebalance_playbook",
    "description": "Builds StakeWise liquidity rebalance plans for yield rotations.",
    "tier": "free",
    "inputSchema": {
    "type": "object",
    "properties": {
...
def stakewise_liquidity_rebalance_playbook(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        _log_lesson("stakewise_liquidity_rebalance_playbook", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
