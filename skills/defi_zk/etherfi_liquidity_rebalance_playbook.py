...
TOOL_META: dict[str, Any] = {
    "name": "etherfi_liquidity_rebalance_playbook",
...
def etherfi_liquidity_rebalance_playbook(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        _log_lesson("etherfi_liquidity_rebalance_playbook", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
