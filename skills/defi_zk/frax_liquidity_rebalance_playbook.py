"""Builds Frax liquidity rebalance plans for yield rotations."""
...
TOOL_META: dict[str, Any] = {
    "name": "frax_liquidity_rebalance_playbook",
    "description": "Builds Frax liquidity rebalance plans for yield rotations.",
    "tier": "free",
    "inputSchema": {
    "type": "object",
    "properties": {
...
def frax_liquidity_rebalance_playbook(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        _log_lesson("frax_liquidity_rebalance_playbook", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
