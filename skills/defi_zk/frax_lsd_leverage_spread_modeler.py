"""Models Frax LSD leverage spreads with health-factor guardrails."""
...
TOOL_META: dict[str, Any] = {
    "name": "frax_lsd_leverage_spread_modeler",
    "description": "Models Frax LSD leverage spreads with health-factor guardrails.",
    "tier": "free",
    "inputSchema": {
    "type": "object",
    "properties": {
...
def frax_lsd_leverage_spread_modeler(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        il_floor = max(0.0, volatility - 0.270) * 100
        ...
        _log_lesson("frax_lsd_leverage_spread_modeler", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
