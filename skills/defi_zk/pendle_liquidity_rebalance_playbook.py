...
TOOL_META: dict[str, Any] = {
    "name": "pendle_liquidity_rebalance_playbook",
...
def pendle_liquidity_rebalance_playbook(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        _log_lesson("pendle_liquidity_rebalance_playbook", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
