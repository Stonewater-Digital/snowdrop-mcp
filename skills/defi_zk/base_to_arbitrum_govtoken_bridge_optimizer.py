...
TOOL_META: dict[str, Any] = {
    "name": "base_to_arbitrum_govtoken_bridge_optimizer",
...
def base_to_arbitrum_govtoken_bridge_optimizer(metrics: Mapping[str, float | int | str]) -> dict[str, Any]:
    """Route governance token transfers from Base to Arbitrum."""
    ...
    try:
        ...
        _log_lesson("base_to_arbitrum_govtoken_bridge_optimizer", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
