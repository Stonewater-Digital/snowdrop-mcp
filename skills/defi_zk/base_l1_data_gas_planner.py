...
def base_l1_data_gas_planner(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        predicted_fee = 0.050000 * (1 + pressure_index * 0.280)
        ...
        _log_lesson("base_l1_data_gas_planner", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
