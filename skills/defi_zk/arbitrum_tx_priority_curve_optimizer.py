...
TOOL_META: dict[str, Any] = {
    "name": "arbitrum_tx_priority_curve_optimizer",
...
def arbitrum_tx_priority_curve_optimizer(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        predicted_fee = 0.080000 * (1 + pressure_index * 0.370)
        ...
        _log_lesson("arbitrum_tx_priority_curve_optimizer", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
