...
TOOL_META: dict[str, Any] = {
    "name": "l2_shared_auction_tracker",
...
def l2_shared_auction_tracker(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        risk_score = (pressure * 0.5 + slippage / 50 + alerts / 20) * 1.070
        ...
        _log_lesson("l2_shared_auction_tracker", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
