---
skill: optimism_l1_data_gas_planner
category: defi_zk
...
```json
{
  "tool": "optimism_l1_data_gas_planner",
  "arguments": {
    "sequencer_backlog": 0,
...
## Usage
Invoke via `snowdrop_execute` with `tool_name: "optimism_l1_data_gas_planner"`.
