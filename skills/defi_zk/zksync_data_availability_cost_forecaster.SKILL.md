---
skill: zksync_data_availability_cost_forecaster
category: defi_zk
...
# Zksync Data Availability Cost Forecaster
...
```json
{
  "tool": "zksync_data_availability_cost_forecaster",
  "arguments": {
...
## Usage
Invoke via `snowdrop_execute` with `tool_name: "zksync_data_availability_cost_forecaster"`.
