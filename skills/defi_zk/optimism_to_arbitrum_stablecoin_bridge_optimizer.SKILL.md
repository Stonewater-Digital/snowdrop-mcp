---
skill: optimism_to_arbitrum_stablecoin_bridge_optimizer
category: defi_zk
...
# Optimism To Arbitrum Stablecoin Bridge Optimizer
...
```json
{
  "tool": "optimism_to_arbitrum_stablecoin_bridge_optimizer",
  "arguments": {
    "amount_usd": 0,
    "urgency": "<urgency>",
    "volatility_index": 0
...
## Usage
Invoke via `snowdrop_execute` with `tool_name: "optimism_to_arbitrum_stablecoin_bridge_optimizer"`.
