---
skill: curve_liquidity_rebalance_playbook
category: defi_zk
...
# Curve Liquidity Rebalance Playbook
...
```json
{
  "tool": "curve_liquidity_rebalance_playbook",
  "arguments": {
    "principal_usd": 0,
    "base_yield_apr": 0,
    "volatility_score": 0,
...
## Usage
Invoke via `snowdrop_execute` with `tool_name: "curve_liquidity_rebalance_playbook"`.
