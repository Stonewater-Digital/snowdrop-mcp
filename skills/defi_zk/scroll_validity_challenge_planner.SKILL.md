---
skill: scroll_validity_challenge_planner
category: defi_zk
...
# Scroll Validity Challenge Planner
...
```json
{
  "tool": "scroll_validity_challenge_planner",
  "arguments": {
...
## Usage
Invoke via `snowdrop_execute` with `tool_name: "scroll_validity_challenge_planner"`.
