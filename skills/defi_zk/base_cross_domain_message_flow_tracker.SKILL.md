---
skill: base_cross_domain_message_flow_tracker
category: defi_zk
...
# Base Cross Domain Message Flow Tracker
...
```json
{
  "tool": "base_cross_domain_message_flow_tracker",
  "arguments": {
    "sequencer_backlog": 0,
...
## Usage
Invoke via `snowdrop_execute` with `tool_name: "base_cross_domain_message_flow_tracker"`.
