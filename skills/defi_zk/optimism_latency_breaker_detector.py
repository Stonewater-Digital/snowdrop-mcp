...
TOOL_META: dict[str, Any] = {
    "name": "optimism_latency_breaker_detector",
...
def optimism_latency_breaker_detector(metrics: Mapping[str, float | int]) -> dict[str, Any]:
    ...
    try:
        ...
        predicted_fee = 0.070000 * (1 + pressure_index * 0.330)
        ...
        _log_lesson("optimism_latency_breaker_detector", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
