"""Executive Summary: Generates restriction matrices mapping jurisdiction plus investor tier combinations.

Focus: Policy coverage within the token compliance pillar.
"""
...
TOOL_META: dict[str, Any] = {
    "name": "token_standard_transfer_restriction_matrix",
    "description": "Generates restriction matrices mapping jurisdiction plus investor tier combinations.",
    "tier": "free",
}


def token_standard_transfer_restriction_matrix(payload: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    """Evaluate control health for Policy.
    ...
    try:
        data = analyze_payload(
            skill_name="token_standard_transfer_restriction_matrix",
            description="Generates restriction matrices mapping jurisdiction plus investor tier combinations.",
            payload=payload,
            focus_tag="policy",
        ...
        _log_lesson("token_standard_transfer_restriction_matrix", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
            "timestamp": timestamp,
