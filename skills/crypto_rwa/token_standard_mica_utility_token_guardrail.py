"""Executive Summary: Checks MiCA utility token criteria to ensure consumer disclosures are adequate.
...
TOOL_META: dict[str, Any] = {
    "name": "token_standard_mica_utility_token_guardrail",
    "description": "Checks MiCA utility token criteria to ensure consumer disclosures are adequate.",
    "tier": "free",
}


def token_standard_mica_utility_token_guardrail(payload: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    try:
        data = analyze_payload(
            skill_name="token_standard_mica_utility_token_guardrail",
            description="Checks MiCA utility token criteria to ensure consumer disclosures are adequate.",
            payload=payload,
            focus_tag="mica",
        ...
        _log_lesson("token_standard_mica_utility_token_guardrail", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
            "timestamp": timestamp,
