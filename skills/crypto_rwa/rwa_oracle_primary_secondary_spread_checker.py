"""Executive Summary: Compares primary issuance prices with secondary token trading to spot gaps.
...
TOOL_META: dict[str, Any] = {
    "name": "rwa_oracle_primary_secondary_spread_checker",
    "description": "Compares primary issuance prices with secondary token trading to spot gaps.",
    "tier": "free",
}


def rwa_oracle_primary_secondary_spread_checker(payload: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    try:
        data = analyze_payload(
            skill_name="rwa_oracle_primary_secondary_spread_checker",
            description="Compares primary issuance prices with secondary token trading to spot gaps.",
            payload=payload,
        ...
        _log_lesson("rwa_oracle_primary_secondary_spread_checker", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
            "timestamp": timestamp,
