"""Executive Summary: Builds Travel Rule payloads for off-ramp transactions initiated by RWA tokens.
...
TOOL_META: dict[str, Any] = {
    "name": "token_standard_travel_rule_payload_builder",
    "description": "Builds Travel Rule payloads for off-ramp transactions initiated by RWA tokens.",
    "tier": "free",
}


def token_standard_travel_rule_payload_builder(payload: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    try:
        data = analyze_payload(
            skill_name="token_standard_travel_rule_payload_builder",
            description="Builds Travel Rule payloads for off-ramp transactions initiated by RWA tokens.",
            payload=payload,
        ...
        _log_lesson("token_standard_travel_rule_payload_builder", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
            "timestamp": timestamp,
