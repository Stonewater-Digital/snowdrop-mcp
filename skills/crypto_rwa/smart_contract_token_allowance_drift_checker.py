"""Executive Summary: Monitors allowances versus expected spend to highlight risky approvals.

Focus: Allowance coverage within the security heuristics pillar.
"""
...
TOOL_META: dict[str, Any] = {
    "name": "smart_contract_token_allowance_drift_checker",
    "description": "Monitors allowances versus expected spend to highlight risky approvals.",
    "tier": "free",
}


def smart_contract_token_allowance_drift_checker(payload: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    """Evaluate control health for Allowance.
    ...
    try:
        data = analyze_payload(
            skill_name="smart_contract_token_allowance_drift_checker",
            description="Monitors allowances versus expected spend to highlight risky approvals.",
            payload=payload,
            focus_tag="allowance",
        ...
        _log_lesson("smart_contract_token_allowance_drift_checker", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
            "timestamp": timestamp,
