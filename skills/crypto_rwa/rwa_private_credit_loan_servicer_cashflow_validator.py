"""Executive Summary: Reconciles servicer remittance files against token payout streams for private credit pools.

Focus: Private Credit coverage within the asset verification pillar.
"""
...
TOOL_META: dict[str, Any] = {
    "name": "rwa_private_credit_loan_servicer_cashflow_validator",
    "description": "Reconciles servicer remittance files against token payout streams for private credit pools.",
    "tier": "free",
}


def rwa_private_credit_loan_servicer_cashflow_validator(payload: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    try:
        data = analyze_payload(
            skill_name="rwa_private_credit_loan_servicer_cashflow_validator",
            description="Reconciles servicer remittance files against token payout streams for private credit pools.",
            payload=payload,
        ...
        _log_lesson("rwa_private_credit_loan_servicer_cashflow_validator", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
            "timestamp": timestamp,
