"""Executive Summary: Maps liquidation preference stacks to ensure payouts follow documentation.
...
TOOL_META: dict[str, Any] = {
    "name": "token_standard_liquidation_preference_mapper",
    "description": "Maps liquidation preference stacks to ensure payouts follow documentation.",
    "tier": "free",
}


def token_standard_liquidation_preference_mapper(payload: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    try:
        data = analyze_payload(
            skill_name="token_standard_liquidation_preference_mapper",
            description="Maps liquidation preference stacks to ensure payouts follow documentation.",
            payload=payload,
        ...
        _log_lesson("token_standard_liquidation_preference_mapper", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
            "timestamp": timestamp,
