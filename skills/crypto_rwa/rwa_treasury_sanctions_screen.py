"""Executive Summary: Screens custodians and counterparties for OFAC flags before settlement.
...
TOOL_META: dict[str, Any] = {
    "name": "rwa_treasury_sanctions_screen",
    "description": "Screens custodians and counterparties for OFAC flags before settlement.",
    "tier": "free",
}


def rwa_treasury_sanctions_screen(payload: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    try:
        data = analyze_payload(
            skill_name="rwa_treasury_sanctions_screen",
            description="Screens custodians and counterparties for OFAC flags before settlement.",
            payload=payload,
            focus_tag="treasury",
        ...
        _log_lesson("rwa_treasury_sanctions_screen", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
            "timestamp": timestamp,
