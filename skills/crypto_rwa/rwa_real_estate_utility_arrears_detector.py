"""Executive Summary: Flags properties with unpaid utility balances or liens impacting collateral quality.
...
TOOL_META: dict[str, Any] = {
    "name": "rwa_real_estate_utility_arrears_detector",
    "description": "Flags properties with unpaid utility balances or liens impacting collateral quality.",
    "tier": "free",
}


def rwa_real_estate_utility_arrears_detector(payload: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    try:
        data = analyze_payload(
            skill_name="rwa_real_estate_utility_arrears_detector",
            description="Flags properties with unpaid utility balances or liens impacting collateral quality.",
            payload=payload,
        ...
        _log_lesson("rwa_real_estate_utility_arrears_detector", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
            "timestamp": timestamp,
