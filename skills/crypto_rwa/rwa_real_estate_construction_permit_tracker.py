"""Executive Summary: Aligns construction draw schedules with permit milestones to gate unlocks.
...
TOOL_META: dict[str, Any] = {
    "name": "rwa_real_estate_construction_permit_tracker",
    "description": "Aligns construction draw schedules with permit milestones to gate unlocks.",
    "tier": "free",
}


def rwa_real_estate_construction_permit_tracker(payload: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    try:
        data = analyze_payload(
            skill_name="rwa_real_estate_construction_permit_tracker",
            description="Aligns construction draw schedules with permit milestones to gate unlocks.",
            payload=payload,
        ...
        _log_lesson("rwa_real_estate_construction_permit_tracker", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
            "timestamp": timestamp,
