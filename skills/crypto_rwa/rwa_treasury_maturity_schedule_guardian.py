"""Executive Summary: Checks that token maturity ladders align with underlying Treasury maturity dates.
...
TOOL_META: dict[str, Any] = {
    "name": "rwa_treasury_maturity_schedule_guardian",
    "description": "Checks that token maturity ladders align with underlying Treasury maturity dates.",
    "tier": "free",
}


def rwa_treasury_maturity_schedule_guardian(payload: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    try:
        data = analyze_payload(
            skill_name="rwa_treasury_maturity_schedule_guardian",
            description="Checks that token maturity ladders align with underlying Treasury maturity dates.",
            payload=payload,
            focus_tag="treasury",
        ...
        _log_lesson("rwa_treasury_maturity_schedule_guardian", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
            "timestamp": timestamp,
