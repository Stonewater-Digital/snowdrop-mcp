"""Executive Summary: Routes delinquency signals to holders and pauses distributions until resolved.
...
TOOL_META: dict[str, Any] = {
    "name": "rwa_private_credit_payment_default_signal_router",
    "description": "Routes delinquency signals to holders and pauses distributions until resolved.",
    "tier": "free",
}


def rwa_private_credit_payment_default_signal_router(payload: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    try:
        data = analyze_payload(
            skill_name="rwa_private_credit_payment_default_signal_router",
            description="Routes delinquency signals to holders and pauses distributions until resolved.",
            payload=payload,
        ...
        _log_lesson("rwa_private_credit_payment_default_signal_router", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
            "timestamp": timestamp,
