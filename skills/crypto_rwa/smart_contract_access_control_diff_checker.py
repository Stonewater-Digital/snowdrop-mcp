"""Executive Summary: Diffs access-control lists between versions to highlight missing roles.
...
TOOL_META: dict[str, Any] = {
    "name": "smart_contract_access_control_diff_checker",
    "description": "Diffs access-control lists between versions to highlight missing roles.",
    "tier": "free",
}


def smart_contract_access_control_diff_checker(payload: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    try:
        data = analyze_payload(
            skill_name="smart_contract_access_control_diff_checker",
            description="Diffs access-control lists between versions to highlight missing roles.",
            payload=payload,
            focus_tag="access",
        ...
        _log_lesson("smart_contract_access_control_diff_checker", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
            "timestamp": timestamp,
