"""Executive Summary: Identifies oracle updates that traders can sandwich before settlement.
...
TOOL_META: dict[str, Any] = {
    "name": "smart_contract_oracle_sandwich_risk_scanner",
    "description": "Identifies oracle updates that traders can sandwich before settlement.",
    "tier": "free",
}


def smart_contract_oracle_sandwich_risk_scanner(payload: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    try:
        data = analyze_payload(
            skill_name="smart_contract_oracle_sandwich_risk_scanner",
            description="Identifies oracle updates that traders can sandwich before settlement.",
            payload=payload,
            focus_tag="oracle",
        ...
        _log_lesson("smart_contract_oracle_sandwich_risk_scanner", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
            "timestamp": timestamp,
