"""Executive Summary: Checks signature verification logic for malleability or unchecked parameters.

Focus: Signatures coverage within the security heuristics pillar.
"""
...
TOOL_META: dict[str, Any] = {
    "name": "smart_contract_signature_malleability_scan",
    "description": "Checks signature verification logic for malleability or unchecked parameters.",
    "tier": "free",
}


def smart_contract_signature_malleability_scan(payload: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    """Evaluate control health for Signatures.
    ...
    try:
        data = analyze_payload(
            skill_name="smart_contract_signature_malleability_scan",
            description="Checks signature verification logic for malleability or unchecked parameters.",
            payload=payload,
            focus_tag="signatures",
        ...
        _log_lesson("smart_contract_signature_malleability_scan", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
            "timestamp": timestamp,
