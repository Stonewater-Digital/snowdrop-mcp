"""Executive Summary: Checks repo leverage agreements to ensure haircuts stay within disclosures.
...
TOOL_META: dict[str, Any] = {
    "name": "rwa_treasury_repo_haircut_compliance_monitor",
    "description": "Checks repo leverage agreements to ensure haircuts stay within disclosures.",
    "tier": "free",
}


def rwa_treasury_repo_haircut_compliance_monitor(payload: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    try:
        data = analyze_payload(
            skill_name="rwa_treasury_repo_haircut_compliance_monitor",
            description="Checks repo leverage agreements to ensure haircuts stay within disclosures.",
            payload=payload,
            focus_tag="treasury",
        ...
        _log_lesson("rwa_treasury_repo_haircut_compliance_monitor", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
            "timestamp": timestamp,
