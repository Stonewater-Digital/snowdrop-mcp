"""Executive Summary: Runs MiCA tests to classify tokens as financial instruments requiring passporting.

Focus: Mica coverage within the token compliance pillar.
"""
...
TOOL_META: dict[str, Any] = {
    "name": "token_standard_mica_security_token_classifier",
    "description": "Runs MiCA tests to classify tokens as financial instruments requiring passporting.",
    "tier": "free",
}


def token_standard_mica_security_token_classifier(payload: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    """Evaluate control health for Mica.
    ...
    try:
        data = analyze_payload(
            skill_name="token_standard_mica_security_token_classifier",
            description="Runs MiCA tests to classify tokens as financial instruments requiring passporting.",
            payload=payload,
            focus_tag="mica",
        ...
        _log_lesson("token_standard_mica_security_token_classifier", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
            "timestamp": timestamp,
