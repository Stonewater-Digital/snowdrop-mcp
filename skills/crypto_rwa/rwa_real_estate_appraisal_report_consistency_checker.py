"""Executive Summary: Checks appraisal comparables and LTV metrics for consistency with disclosure packets.
...
TOOL_META: dict[str, Any] = {
    "name": "rwa_real_estate_appraisal_report_consistency_checker",
    "description": "Checks appraisal comparables and LTV metrics for consistency with disclosure packets.",
    "tier": "free",
}


def rwa_real_estate_appraisal_report_consistency_checker(payload: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    try:
        data = analyze_payload(
            skill_name="rwa_real_estate_appraisal_report_consistency_checker",
            description="Checks appraisal comparables and LTV metrics for consistency with disclosure packets.",
            payload=payload,
        ...
        _log_lesson("rwa_real_estate_appraisal_report_consistency_checker", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
            "timestamp": timestamp,
