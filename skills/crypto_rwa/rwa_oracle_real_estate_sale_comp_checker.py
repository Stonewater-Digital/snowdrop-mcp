"""Executive Summary: Confirms sale comparables feeding residential tokens align with MLS data.

Focus: Real Estate coverage within the oracle reconciliation pillar.
"""
...
TOOL_META: dict[str, Any] = {
    "name": "rwa_oracle_real_estate_sale_comp_checker",
    "description": "Confirms sale comparables feeding residential tokens align with MLS data.",
    "tier": "free",
}


def rwa_oracle_real_estate_sale_comp_checker(payload: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    try:
        data = analyze_payload(
            skill_name="rwa_oracle_real_estate_sale_comp_checker",
            description="Confirms sale comparables feeding residential tokens align with MLS data.",
            payload=payload,
        ...
        _log_lesson("rwa_oracle_real_estate_sale_comp_checker", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
            "timestamp": timestamp,
