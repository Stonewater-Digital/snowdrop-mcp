"""Executive Summary: Compares implied token discounts to the live Treasury curve to spot mispricing.
...
TOOL_META: dict[str, Any] = {
    "name": "rwa_treasury_discount_curve_checker",
    "description": "Compares implied token discounts to the live Treasury curve to spot mispricing.",
    "tier": "free",
}


def rwa_treasury_discount_curve_checker(payload: dict[str, Any], context: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    try:
        data = analyze_payload(
            skill_name="rwa_treasury_discount_curve_checker",
            description="Compares implied token discounts to the live Treasury curve to spot mispricing.",
            payload=payload,
            focus_tag="treasury",
        ...
        _log_lesson("rwa_treasury_discount_curve_checker", str(exc))
        return {
            "status": "error",
            "data": {"error": str(exc)},
            "timestamp": timestamp,
