"""Executive Summary: Simulates cash deployment from equity carveouts vs. balance-sheet needs.
"""
...
SKILL_NAME = "carveout_proceeds_allocator"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Simulates cash deployment from equity carveouts vs. balance-sheet needs."
...
def carveout_proceeds_allocator(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Simulates cash deployment from equity carveouts vs. balance-sheet needs. This function
