"""Executive Summary: Values buy-in economics vs. minority protections and cash flow splits.
"""
...
SKILL_NAME = "minority_interest_buyin_model"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Values buy-in economics vs. minority protections and cash flow splits."
...
def minority_interest_buyin_model(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Values buy-in economics vs. minority protections and cash flow splits. This function
