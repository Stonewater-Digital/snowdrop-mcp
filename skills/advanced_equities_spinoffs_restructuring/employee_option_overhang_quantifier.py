"""Executive Summary: Measures equity overhang vs. expected dilution through restructuring.
"""
...
SKILL_NAME = "employee_option_overhang_quantifier"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Measures equity overhang vs. expected dilution through restructuring."
...
def employee_option_overhang_quantifier(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Measures equity overhang vs. expected dilution through restructuring. This function
