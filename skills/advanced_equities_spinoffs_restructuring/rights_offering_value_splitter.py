"""Executive Summary: Values tradable rights vs. subscription commitments using historical take-up
rates.
"""
...
SKILL_NAME = "rights_offering_value_splitter"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Values tradable rights vs. subscription commitments using historical take-up rates."
...
def rights_offering_value_splitter(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Values tradable rights vs. subscription commitments using historical take-up rates. This
