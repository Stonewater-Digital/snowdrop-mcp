"""Executive Summary: Scores restructurings on margin recovery speed relative to guidance.
"""
...
SKILL_NAME = "declining_margin_turnaround_monitor"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Scores restructurings on margin recovery speed relative to guidance."
...
def declining_margin_turnaround_monitor(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Scores restructurings on margin recovery speed relative to guidance. This function
