"""Executive Summary: Projects covenant breaches and equity cure sizing windows.
"""
...
SKILL_NAME = "equity_cure_need_forecaster"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Projects covenant breaches and equity cure sizing windows."
...
def equity_cure_need_forecaster(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Projects covenant breaches and equity cure sizing windows. This function synthesizes
