"""Executive Summary: Tests thresholds and dilution math for outstanding shareholder rights plans.
"""
...
SKILL_NAME = "poison_pill_trigger_analyzer"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Tests thresholds and dilution math for outstanding shareholder rights plans."
...
def poison_pill_trigger_analyzer(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Tests thresholds and dilution math for outstanding shareholder rights plans. This
