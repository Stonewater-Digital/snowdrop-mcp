"""Executive Summary: Outlines likely covenant reset packages from precedent negotiations.
"""
...
SKILL_NAME = "covenant_reset_playbook_builder"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Outlines likely covenant reset packages from precedent negotiations."
...
def covenant_reset_playbook_builder(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Outlines likely covenant reset packages from precedent negotiations. This function
