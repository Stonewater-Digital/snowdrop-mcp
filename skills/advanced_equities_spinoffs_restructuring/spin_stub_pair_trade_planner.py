"""Executive Summary: Designs hedges between parent and spin based on float/weight forecasts.
"""
...
SKILL_NAME = "spin_stub_pair_trade_planner"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Designs hedges between parent and spin based on float/weight forecasts."
...
TOOL_META: dict[str, Any] = {
    "name": SKILL_NAME,
    "tier": "free",
    "description": "Designs hedges between parent and spin based on float/weight forecasts.",
    "inputSchema": {
        "type": "object",
        "properties": {
            "tickers": {
...
def spin_stub_pair_trade_planner(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Designs hedges between parent and spin based on float/weight forecasts. This function
