"""Executive Summary: Simulates ownership shifts to protect Section 382 limits.
"""
...
SKILL_NAME = "section382_cap_table_guard"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Simulates ownership shifts to protect Section 382 limits."
...
def section382_cap_table_guard(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Simulates ownership shifts to protect Section 382 limits. This function synthesizes
