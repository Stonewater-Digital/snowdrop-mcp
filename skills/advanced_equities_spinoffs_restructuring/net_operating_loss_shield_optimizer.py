"""Executive Summary: Maps NOL usage scenarios to protect tax assets post-transaction.
"""
...
SKILL_NAME = "net_operating_loss_shield_optimizer"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Maps NOL usage scenarios to protect tax assets post-transaction."
...
def net_operating_loss_shield_optimizer(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Maps NOL usage scenarios to protect tax assets post-transaction. This function
