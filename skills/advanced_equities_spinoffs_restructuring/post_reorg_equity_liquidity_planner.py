"""Executive Summary: Forecasts float, turnover, and lockups for newly listed post-reorg equities.
"""
...
SKILL_NAME = "post_reorg_equity_liquidity_planner"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Forecasts float, turnover, and lockups for newly listed post-reorg equities."
...
def post_reorg_equity_liquidity_planner(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Forecasts float, turnover, and lockups for newly listed post-reorg equities. This
