"""Executive Summary: Scores restructurings shifting to asset-light models based on margin
potential.
"""
...
SKILL_NAME = "asset_light_transition_scorecard"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Scores restructurings shifting to asset-light models based on margin potential."
...
def asset_light_transition_scorecard(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Scores restructurings shifting to asset-light models based on margin potential. This
