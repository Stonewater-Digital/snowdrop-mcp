"""Executive Summary: Tracks index add/drop impacts following spin-effective dates.
"""
...
SKILL_NAME = "post_spin_index_inclusion_tracker"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Tracks index add/drop impacts following spin-effective dates."
...
def post_spin_index_inclusion_tracker(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Tracks index add/drop impacts following spin-effective dates. This function synthesizes
