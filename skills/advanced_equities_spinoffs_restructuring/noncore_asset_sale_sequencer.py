"""Executive Summary: Orders asset dispositions to maximize deleveraging and valuation uplift.
"""
...
SKILL_NAME = "noncore_asset_sale_sequencer"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Orders asset dispositions to maximize deleveraging and valuation uplift."
...
def noncore_asset_sale_sequencer(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Orders asset dispositions to maximize deleveraging and valuation uplift. This function
