"""Executive Summary: Maps tender/exchange sequences to assess residual capital structure risk.
"""
...
SKILL_NAME = "liability_management_transaction_mapper"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Maps tender/exchange sequences to assess residual capital structure risk."
...
def liability_management_transaction_mapper(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Maps tender/exchange sequences to assess residual capital structure risk. This function
