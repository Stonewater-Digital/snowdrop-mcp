"""Executive Summary: Computes break-even for tracking stock conversions and rollups.
"""
...
SKILL_NAME = "tracking_stock_break_even_solver"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Computes break-even for tracking stock conversions and rollups."
...
def tracking_stock_break_even_solver(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Computes break-even for tracking stock conversions and rollups. This function
