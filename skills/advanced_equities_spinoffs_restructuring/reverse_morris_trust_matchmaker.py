"""Executive Summary: Suggests RMT partners using complementary tax bases and strategic fit.
"""
...
SKILL_NAME = "reverse_morris_trust_matchmaker"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Suggests RMT partners using complementary tax bases and strategic fit."
...
TOOL_META: dict[str, Any] = {
    "name": SKILL_NAME,
    "tier": "free",
    "description": "Suggests RMT partners using complementary tax bases and strategic fit.",
    "inputSchema": {
        "type": "object",
        "properties": {
            "tickers": {
...
def reverse_morris_trust_matchmaker(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Suggests RMT partners using complementary tax bases and strategic fit. This function
    synthesizes advanced equities (spinoffs / restructuring) insights using deterministic
