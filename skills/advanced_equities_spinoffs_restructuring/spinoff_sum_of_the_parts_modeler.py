"""Executive Summary: Aggregates segment data into SOP valuations to benchmark spin stub pricing.
"""
...
SKILL_NAME = "spinoff_sum_of_the_parts_modeler"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Aggregates segment data into SOP valuations to benchmark spin stub pricing."
...
def spinoff_sum_of_the_parts_modeler(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Aggregates segment data into SOP valuations to benchmark spin stub pricing. This
