"""Executive Summary: Tracks super-voting share collapse triggers to anticipate governance shifts.
"""
...
SKILL_NAME = "supervoting_conversion_timer"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Tracks super-voting share collapse triggers to anticipate governance shifts."
...
def supervoting_conversion_timer(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Tracks super-voting share collapse triggers to anticipate governance shifts. This
