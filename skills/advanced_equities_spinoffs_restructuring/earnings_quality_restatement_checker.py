"""Executive Summary: Flags restatement risk from irregular accruals and audit comments.
"""
...
SKILL_NAME = "earnings_quality_restatement_checker"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Flags restatement risk from irregular accruals and audit comments."
...
def earnings_quality_restatement_checker(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Flags restatement risk from irregular accruals and audit comments. This function
