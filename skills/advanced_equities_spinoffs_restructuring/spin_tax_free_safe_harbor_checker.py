"""Executive Summary: Tests transactions against IRS safe harbor requirements for tax-free status.
"""
...
SKILL_NAME = "spin_tax_free_safe_harbor_checker"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Tests transactions against IRS safe harbor requirements for tax-free status."
...
def spin_tax_free_safe_harbor_checker(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Tests transactions against IRS safe harbor requirements for tax-free status. This
