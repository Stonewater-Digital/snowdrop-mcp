"""Executive Summary: Charts leverage trajectories under various asset sale and EBITDA scenarios.
"""
...
SKILL_NAME = "deleveraging_path_visualizer"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Charts leverage trajectories under various asset sale and EBITDA scenarios."
...
def deleveraging_path_visualizer(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Charts leverage trajectories under various asset sale and EBITDA scenarios. This
