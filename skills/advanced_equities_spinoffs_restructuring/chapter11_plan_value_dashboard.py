"""Executive Summary: Compares plan recovery waterfalls against market pricing for multiple
classes.
"""
...
SKILL_NAME = "chapter11_plan_value_dashboard"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Compares plan recovery waterfalls against market pricing for multiple classes."
...
def chapter11_plan_value_dashboard(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Compares plan recovery waterfalls against market pricing for multiple classes. This
