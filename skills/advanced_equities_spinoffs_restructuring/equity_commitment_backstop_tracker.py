"""Executive Summary: Monitors rights backstop size, participants, and pricing fairness.
"""
...
SKILL_NAME = "equity_commitment_backstop_tracker"
NICHE = "Advanced Equities (Spinoffs / Restructuring)"
ANALYSIS_FOCUS = "Monitors rights backstop size, participants, and pricing fairness."
...
def equity_commitment_backstop_tracker(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Monitors rights backstop size, participants, and pricing fairness. This function
