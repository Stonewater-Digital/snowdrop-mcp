"""Executive Summary: Visualizes theta decay pockets across expiries and strikes.
"""
...
SKILL_NAME = "theta_decay_heatmap_builder"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Visualizes theta decay pockets across expiries and strikes."
...
def theta_decay_heatmap_builder(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Visualizes theta decay pockets across expiries and strikes. This function synthesizes
