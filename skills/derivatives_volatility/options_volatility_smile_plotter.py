"""Executive Summary: Builds smile curves from free option chains and overlays realized anchors.
"""
...
SKILL_NAME = "options_volatility_smile_plotter"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Builds smile curves from free option chains and overlays realized anchors."
...
def options_volatility_smile_plotter(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Builds smile curves from free option chains and overlays realized anchors. This function
