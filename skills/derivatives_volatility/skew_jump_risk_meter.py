"""Executive Summary: Quantifies skew jump risk around catalysts using historical skew shocks.
"""
...
SKILL_NAME = "skew_jump_risk_meter"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Quantifies skew jump risk around catalysts using historical skew shocks."
...
def skew_jump_risk_meter(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Quantifies skew jump risk around catalysts using historical skew shocks. This function
