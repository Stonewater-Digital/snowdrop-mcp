"""Executive Summary: Reconstructs dealer gamma exposure using OI, delta, and borrow metrics.
"""
...
SKILL_NAME = "gamma_squeeze_exposure_tracker"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Reconstructs dealer gamma exposure using OI, delta, and borrow metrics."
...
def gamma_squeeze_exposure_tracker(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Reconstructs dealer gamma exposure using OI, delta, and borrow metrics. This function
