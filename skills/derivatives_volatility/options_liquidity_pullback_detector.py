"""Executive Summary: Detects widening bid-ask spreads and volume drops signaling liquidity stress.
"""
...
SKILL_NAME = "options_liquidity_pullback_detector"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Detects widening bid-ask spreads and volume drops signaling liquidity stress."
...
def options_liquidity_pullback_detector(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Detects widening bid-ask spreads and volume drops signaling liquidity stress. This
    function synthesizes derivatives / volatility insights using deterministic fallback data
