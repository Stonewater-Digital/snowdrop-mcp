"""Executive Summary: Backtests skew steepener ideas across time using synthetic option data.
"""
...
SKILL_NAME = "skew_steepener_backtest_lab"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Backtests skew steepener ideas across time using synthetic option data."
...
def skew_steepener_backtest_lab(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Backtests skew steepener ideas across time using synthetic option data. This function
