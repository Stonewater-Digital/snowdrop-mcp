"""Executive Summary: Identifies large OI rolls indicating positioning shifts.
"""
...
SKILL_NAME = "options_open_interest_rotation_monitor"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Identifies large OI rolls indicating positioning shifts."
...
def options_open_interest_rotation_monitor(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Identifies large OI rolls indicating positioning shifts. This function synthesizes
