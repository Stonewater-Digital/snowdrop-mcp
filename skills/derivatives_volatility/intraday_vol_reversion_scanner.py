"""Executive Summary: Detects intraday vol spikes likely to mean revert based on order book
metrics.
"""
...
SKILL_NAME = "intraday_vol_reversion_scanner"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Detects intraday vol spikes likely to mean revert based on order book metrics."
...
def intraday_vol_reversion_scanner(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Detects intraday vol spikes likely to mean revert based on order book metrics. This
