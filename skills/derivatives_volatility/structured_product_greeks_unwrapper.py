"""Executive Summary: Decomposes popular retail structured products into Greek exposures.
"""
...
SKILL_NAME = "structured_product_greeks_unwrapper"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Decomposes popular retail structured products into Greek exposures."
...
TOOL_META: dict[str, Any] = {
    "name": SKILL_NAME,
    "tier": "free",
    "description": "Decomposes popular retail structured products into Greek exposures.",
    "inputSchema": {
        "type": "object",
        "properties": {
            "tickers": {
...
def structured_product_greeks_unwrapper(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Decomposes popular retail structured products into Greek exposures. This function
    synthesizes derivatives / volatility insights using deterministic fallback data when
    real-time feeds are unavailable.
