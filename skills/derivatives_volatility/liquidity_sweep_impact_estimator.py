"""Executive Summary: Estimates market impact from large option sweeps to manage slippage.
"""
...
SKILL_NAME = "liquidity_sweep_impact_estimator"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Estimates market impact from large option sweeps to manage slippage."
...
def liquidity_sweep_impact_estimator(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Estimates market impact from large option sweeps to manage slippage. This function
