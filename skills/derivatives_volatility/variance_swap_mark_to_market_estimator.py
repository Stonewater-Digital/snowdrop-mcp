"""Executive Summary: Calculates MTM on listed variance swaps using free realized data.
"""
...
SKILL_NAME = "variance_swap_mark_to_market_estimator"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Calculates MTM on listed variance swaps using free realized data."
...
def variance_swap_mark_to_market_estimator(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Calculates MTM on listed variance swaps using free realized data. This function
