"""Executive Summary: Tracks decay and rebalance drag in vol-linked ETFs.
"""
...
SKILL_NAME = "volatility_etf_decay_tracker"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Tracks decay and rebalance drag in vol-linked ETFs."
...
def volatility_etf_decay_tracker(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Tracks decay and rebalance drag in vol-linked ETFs. This function synthesizes
