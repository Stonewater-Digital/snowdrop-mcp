"""Executive Summary: Estimates barrier hit probabilities using free implied vol data.
"""
...
SKILL_NAME = "exotic_barrier_breach_probability_engine"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Estimates barrier hit probabilities using free implied vol data."
...
def exotic_barrier_breach_probability_engine(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Estimates barrier hit probabilities using free implied vol data. This function
