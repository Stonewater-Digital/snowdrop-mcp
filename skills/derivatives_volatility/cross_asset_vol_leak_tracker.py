"""Executive Summary: Tracks vol lead-lag between equities and credit/commodities proxies to inform
trades.
"""
...
SKILL_NAME = "cross_asset_vol_leak_tracker"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Tracks vol lead-lag between equities and credit/commodities proxies to inform trades."
...
TOOL_META: dict[str, Any] = {
    "name": SKILL_NAME,
    "tier": "free",
    "description": "Tracks vol lead-lag between equities and credit/commodities proxies to inform trades.",
    "inputSchema": {
        "type": "object",
        "properties": {
            "tickers": {
...
def cross_asset_vol_leak_tracker(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Tracks vol lead-lag between equities and credit/commodities proxies to inform trades.
    This function synthesizes derivatives / volatility insights using deterministic fallback
    data when real-time feeds are unavailable.
