"""Executive Summary: Builds forward vol curves from listed options to spot anomalies.
"""
...
SKILL_NAME = "forward_vol_calendar_curve_builder"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Builds forward vol curves from listed options to spot anomalies."
...
def forward_vol_calendar_curve_builder(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Builds forward vol curves from listed options to spot anomalies. This function
