"""Executive Summary: Clusters notable options prints to surface stealth positioning.
"""
...
SKILL_NAME = "options_flow_clustering_model"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Clusters notable options prints to surface stealth positioning."
...
def options_flow_clustering_model(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Clusters notable options prints to surface stealth positioning. This function
