"""Executive Summary: Relates single-name vol to index implied correlation for dispersion plays.
"""
...
SKILL_NAME = "dispersion_vs_correlation_mapper"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Relates single-name vol to index implied correlation for dispersion plays."
...
def dispersion_vs_correlation_mapper(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Relates single-name vol to index implied correlation for dispersion plays. This function
