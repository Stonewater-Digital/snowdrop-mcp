"""Executive Summary: Matches portfolio beta to best-fit tail hedge structures with payoff tables.
"""
...
SKILL_NAME = "tail_hedge_payoff_matcher"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Matches portfolio beta to best-fit tail hedge structures with payoff tables."
...
def tail_hedge_payoff_matcher(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Matches portfolio beta to best-fit tail hedge structures with payoff tables. This
