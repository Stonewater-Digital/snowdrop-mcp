"""Executive Summary: Projects re-hedge frequency and cost for popular option structures.
"""
...
SKILL_NAME = "delta_hedge_cost_forecaster"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Projects re-hedge frequency and cost for popular option structures."
...
def delta_hedge_cost_forecaster(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Projects re-hedge frequency and cost for popular option structures. This function
