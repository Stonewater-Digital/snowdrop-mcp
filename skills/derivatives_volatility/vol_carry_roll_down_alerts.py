"""Executive Summary: Alerts when rolling long-vol positions offers attractive carry improvements.
"""
...
SKILL_NAME = "vol_carry_roll_down_alerts"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Alerts when rolling long-vol positions offers attractive carry improvements."
...
def vol_carry_roll_down_alerts(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Alerts when rolling long-vol positions offers attractive carry improvements. This
