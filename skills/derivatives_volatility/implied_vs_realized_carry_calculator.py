"""Executive Summary: Compares implied carry vs. realized vol for vol selling strategies.
"""
...
SKILL_NAME = "implied_vs_realized_carry_calculator"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Compares implied carry vs. realized vol for vol selling strategies."
...
def implied_vs_realized_carry_calculator(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Compares implied carry vs. realized vol for vol selling strategies. This function
