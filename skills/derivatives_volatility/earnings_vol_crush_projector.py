"""Executive Summary: Projects vol crush magnitude after earnings using historical analogs.
"""
...
SKILL_NAME = "earnings_vol_crush_projector"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Projects vol crush magnitude after earnings using historical analogs."
...
def earnings_vol_crush_projector(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Projects vol crush magnitude after earnings using historical analogs. This function
