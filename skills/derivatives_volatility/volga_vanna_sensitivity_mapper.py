"""Executive Summary: Computes second-order Greeks to guide exotic options hedging.
"""
...
SKILL_NAME = "volga_vanna_sensitivity_mapper"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Computes second-order Greeks to guide exotic options hedging."
...
def volga_vanna_sensitivity_mapper(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Computes second-order Greeks to guide exotic options hedging. This function synthesizes
