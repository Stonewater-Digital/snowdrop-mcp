"""Executive Summary: Simulates P&L paths for iron condors, butterflies, and ratio spreads.
"""
...
SKILL_NAME = "multi_leg_strategy_pnl_simulator"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Simulates P&L paths for iron condors, butterflies, and ratio spreads."
...
def multi_leg_strategy_pnl_simulator(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Simulates P&L paths for iron condors, butterflies, and ratio spreads. This function
