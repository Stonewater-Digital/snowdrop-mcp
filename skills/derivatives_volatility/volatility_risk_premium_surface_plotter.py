"""Executive Summary: Maps VRP across tenors and strikes for strategy selection.
"""
...
SKILL_NAME = "volatility_risk_premium_surface_plotter"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Maps VRP across tenors and strikes for strategy selection."
...
def volatility_risk_premium_surface_plotter(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Maps VRP across tenors and strikes for strategy selection. This function synthesizes
