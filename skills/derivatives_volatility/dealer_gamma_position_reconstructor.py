"""Executive Summary: Infers dealer gamma balance using OI ladder and price levels.
"""
...
SKILL_NAME = "dealer_gamma_position_reconstructor"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Infers dealer gamma balance using OI ladder and price levels."
...
def dealer_gamma_position_reconstructor(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Infers dealer gamma balance using OI ladder and price levels. This function synthesizes
    derivatives / volatility insights using deterministic fallback data when real-time feeds
    are unavailable.
