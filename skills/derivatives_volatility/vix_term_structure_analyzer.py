"""Executive Summary: Charts VIX futures curve shape vs. realized vol to identify steepening
trades.
"""
...
SKILL_NAME = "vix_term_structure_analyzer"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Charts VIX futures curve shape vs. realized vol to identify steepening trades."
...
def vix_term_structure_analyzer(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Charts VIX futures curve shape vs. realized vol to identify steepening trades. This
