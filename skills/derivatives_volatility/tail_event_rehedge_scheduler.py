"""Executive Summary: Automates re-hedge reminders when vol regime shifts breach thresholds.
"""
...
SKILL_NAME = "tail_event_rehedge_scheduler"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Automates re-hedge reminders when vol regime shifts breach thresholds."
...
def tail_event_rehedge_scheduler(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Automates re-hedge reminders when vol regime shifts breach thresholds. This function
