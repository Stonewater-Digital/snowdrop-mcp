"""Executive Summary: Optimizes calendar spreads by simulating theta bleed vs. vol drift.
"""
...
SKILL_NAME = "calendar_spread_decay_optimizer"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Optimizes calendar spreads by simulating theta bleed vs. vol drift."
...
def calendar_spread_decay_optimizer(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Optimizes calendar spreads by simulating theta bleed vs. vol drift. This function
