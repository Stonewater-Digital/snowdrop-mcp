"""Executive Summary: Labels vol regimes (contango/backwardation) and ties them to macro states.
"""
...
SKILL_NAME = "vol_surface_regime_classifier"
NICHE = "Derivatives / Volatility"
ANALYSIS_FOCUS = "Labels vol regimes (contango/backwardation) and ties them to macro states."
...
def vol_surface_regime_classifier(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Labels vol regimes (contango/backwardation) and ties them to macro states. This function
