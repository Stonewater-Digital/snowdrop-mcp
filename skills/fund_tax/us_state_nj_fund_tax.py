...
Source of truth: snowdrop-core/skills/premium/fund_tax/us_state_nj_fund_tax.py
...
def us_state_nj_fund_tax() -> dict:
    """Premium skill — subscribe to access full implementation."""
    return paywall_response("us_state_nj_fund_tax")
