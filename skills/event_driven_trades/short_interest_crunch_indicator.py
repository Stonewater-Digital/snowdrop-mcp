"""Executive Summary: Combines short interest days-to-cover with catalyst calendar to time
squeezes.
"""
...
SKILL_NAME = "short_interest_crunch_indicator"
NICHE = "Event-Driven Trades"
ANALYSIS_FOCUS = "Combines short interest days-to-cover with catalyst calendar to time squeezes."
...
def short_interest_crunch_indicator(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Combines short interest days-to-cover with catalyst calendar to time squeezes. This
