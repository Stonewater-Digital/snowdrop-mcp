"""Executive Summary: Compares historical launch announcements to realized demand signals to gauge
trade direction.
"""
...
SKILL_NAME = "product_launch_trade_setup"
NICHE = "Event-Driven Trades"
ANALYSIS_FOCUS = "Compares historical launch announcements to realized demand signals to gauge trade direction."
...
def product_launch_trade_setup(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Compares historical launch announcements to realized demand signals to gauge trade
    direction. This function synthesizes event-driven trades insights using deterministic
