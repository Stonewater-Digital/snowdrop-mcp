"""Executive Summary: Maps management guidance changes against Street revisions to spot underpriced
sentiment swings.
"""
...
SKILL_NAME = "guidance_revision_heatmap"
NICHE = "Event-Driven Trades"
ANALYSIS_FOCUS = "Maps management guidance changes against Street revisions to spot underpriced sentiment swings."
...
TOOL_META: dict[str, Any] = {
    "name": SKILL_NAME,
    "tier": "free",
    "description": "Maps management guidance changes against Street revisions to spot underpriced sentiment swings.",
    "inputSchema": {
        "type": "object",
        "properties": {
            "tickers": {
...
def guidance_revision_heatmap(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Maps management guidance changes against Street revisions to spot underpriced sentiment
    swings. This function synthesizes event-driven trades insights using deterministic
    fallback data when real-time feeds are unavailable.
