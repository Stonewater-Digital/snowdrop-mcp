"""Executive Summary: Estimates when dual-class sunsets or pressure points could unlock governance
catalysts.
"""
...
SKILL_NAME = "dual_class_collapse_timer"
NICHE = "Event-Driven Trades"
ANALYSIS_FOCUS = "Estimates when dual-class sunsets or pressure points could unlock governance catalysts."
