"""Executive Summary: Uses shipping-data and supplier earnings to anticipate company-specific
supply hits.
"""
...
SKILL_NAME = "supply_chain_disruption_signal_board"
NICHE = "Event-Driven Trades"
ANALYSIS_FOCUS = "Uses shipping-data and supplier earnings to anticipate company-specific supply hits."
...
def supply_chain_disruption_signal_board(
