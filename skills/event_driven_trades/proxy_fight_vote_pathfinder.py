"""Executive Summary: Visualizes proxy math, record dates, and swing ballots for live contested
meetings.
"""
...
SKILL_NAME = "proxy_fight_vote_pathfinder"
NICHE = "Event-Driven Trades"
ANALYSIS_FOCUS = "Visualizes proxy math, record dates, and swing ballots for live contested meetings."
...
def proxy_fight_vote_pathfinder(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Visualizes proxy math, record dates, and swing ballots for live contested meetings. This
