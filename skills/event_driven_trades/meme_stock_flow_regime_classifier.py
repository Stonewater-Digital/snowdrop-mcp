"""Executive Summary: Detects social-volume and borrow-cost trigger points that precede melt-up or
crash phases.
"""
...
SKILL_NAME = "meme_stock_flow_regime_classifier"
NICHE = "Event-Driven Trades"
ANALYSIS_FOCUS = "Detects social-volume and borrow-cost trigger points that precede melt-up or crash phases."
...
def meme_stock_flow_regime_classifier(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Detects social-volume and borrow-cost trigger points that precede melt-up or crash
    phases. This function synthesizes event-driven trades insights using deterministic
