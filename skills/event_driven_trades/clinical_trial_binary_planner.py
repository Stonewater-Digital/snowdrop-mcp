"""Executive Summary: Builds probability-weighted payoff trees for pivotal biotech readouts using
open FDA calendars.
"""
...
SKILL_NAME = "clinical_trial_binary_planner"
NICHE = "Event-Driven Trades"
ANALYSIS_FOCUS = "Builds probability-weighted payoff trees for pivotal biotech readouts using open FDA calendars."
...
def clinical_trial_binary_planner(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Builds probability-weighted payoff trees for pivotal biotech readouts using open FDA
    calendars. This function synthesizes event-driven trades insights using deterministic
