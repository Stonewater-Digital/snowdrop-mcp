"""Executive Summary: Flags jurisdictions with rising policy risks affecting pending company-level
events.
"""
...
SKILL_NAME = "cross_border_event_heat_gauge"
NICHE = "Event-Driven Trades"
ANALYSIS_FOCUS = "Flags jurisdictions with rising policy risks affecting pending company-level events."
...
def cross_border_event_heat_gauge(
