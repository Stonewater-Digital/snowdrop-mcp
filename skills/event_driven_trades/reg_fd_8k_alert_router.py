"""Executive Summary: Streams fresh 8-Ks, tags material language, and suggests contextual
playbooks.
"""
...
SKILL_NAME = "reg_fd_8k_alert_router"
NICHE = "Event-Driven Trades"
ANALYSIS_FOCUS = "Streams fresh 8-Ks, tags material language, and suggests contextual playbooks."
...
def reg_fd_8k_alert_router(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Streams fresh 8-Ks, tags material language, and suggests contextual playbooks. This
