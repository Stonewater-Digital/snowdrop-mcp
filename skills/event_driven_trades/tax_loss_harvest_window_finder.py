"""Executive Summary: Identifies crowded losers with elevated December bounce odds using seasonal
factor models.
"""
...
SKILL_NAME = "tax_loss_harvest_window_finder"
NICHE = "Event-Driven Trades"
ANALYSIS_FOCUS = "Identifies crowded losers with elevated December bounce odds using seasonal factor models."
...
def tax_loss_harvest_window_finder(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Identifies crowded losers with elevated December bounce odds using seasonal factor
    models. This function synthesizes event-driven trades insights using deterministic
