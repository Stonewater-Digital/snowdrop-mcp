"""Executive Summary: Quantifies historical post-earnings gaps vs. implied move to flag asymmetric
setups using free price feeds.
"""
...
SKILL_NAME = "earnings_gap_playbook"
NICHE = "Event-Driven Trades"
ANALYSIS_FOCUS = "Quantifies historical post-earnings gaps vs. implied move to flag asymmetric setups using free price feeds."
...
def earnings_gap_playbook(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Quantifies historical post-earnings gaps vs. implied move to flag asymmetric setups
    using free price feeds. This function synthesizes event-driven trades insights using
