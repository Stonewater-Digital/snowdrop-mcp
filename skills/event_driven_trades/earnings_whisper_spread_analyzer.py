"""Executive Summary: Measures gap between whisper numbers and official consensus to weight
surprise odds.
"""
...
SKILL_NAME = "earnings_whisper_spread_analyzer"
NICHE = "Event-Driven Trades"
ANALYSIS_FOCUS = "Measures gap between whisper numbers and official consensus to weight surprise odds."
...
def earnings_whisper_spread_analyzer(
