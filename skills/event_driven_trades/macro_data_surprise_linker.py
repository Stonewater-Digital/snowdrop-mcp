"""Executive Summary: Connects company guidance sensitivity with upcoming macro releases to prime
event trays.
"""
...
SKILL_NAME = "macro_data_surprise_linker"
NICHE = "Event-Driven Trades"
ANALYSIS_FOCUS = "Connects company guidance sensitivity with upcoming macro releases to prime event trays."
...
def macro_data_surprise_linker(
