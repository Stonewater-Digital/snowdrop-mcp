"""Executive Summary: Aggregates public datapoints (earnings calls, supply chain indices) into
actionable sales inflection alerts.
"""
...
SKILL_NAME = "vendor_channel_check_synthesizer"
NICHE = "Event-Driven Trades"
ANALYSIS_FOCUS = "Aggregates public datapoints (earnings calls, supply chain indices) into actionable sales inflection alerts."
...
def vendor_channel_check_synthesizer(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Aggregates public datapoints (earnings calls, supply chain indices) into actionable
    sales inflection alerts. This function synthesizes event-driven trades insights using
