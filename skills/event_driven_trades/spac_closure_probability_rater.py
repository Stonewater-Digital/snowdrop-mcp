"""Executive Summary: Scores SPAC deals using redemption levels, sponsor incentives, and regulatory
risk.
"""
...
SKILL_NAME = "spac_closure_probability_rater"
NICHE = "Event-Driven Trades"
ANALYSIS_FOCUS = "Scores SPAC deals using redemption levels, sponsor incentives, and regulatory risk."
...
def spac_closure_probability_rater(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Scores SPAC deals using redemption levels, sponsor incentives, and regulatory risk. This
    function synthesizes event-driven trades insights using deterministic fallback data when
