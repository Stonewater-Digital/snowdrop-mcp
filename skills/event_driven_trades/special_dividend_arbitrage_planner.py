"""Executive Summary: Evaluates pre/post special dividend payout value capture tactics including
deep ITM options.
"""
...
SKILL_NAME = "special_dividend_arbitrage_planner"
NICHE = "Event-Driven Trades"
ANALYSIS_FOCUS = "Evaluates pre/post special dividend payout value capture tactics including deep ITM options."
...
def special_dividend_arbitrage_planner(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Evaluates pre/post special dividend payout value capture tactics including deep ITM
    options. This function synthesizes event-driven trades insights using deterministic
