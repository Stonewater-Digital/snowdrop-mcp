"""Executive Summary: Quantifies lockup expirations' float impact and price response odds.
"""
...
SKILL_NAME = "share_lockup_expiry_pressure_meter"
NICHE = "Event-Driven Trades"
ANALYSIS_FOCUS = "Quantifies lockup expirations' float impact and price response odds."
...
def share_lockup_expiry_pressure_meter(
    tickers: Sequence[str] | None = None,
    lookback_days: int = DEFAULT_LOOKBACK_DAYS,
    analysis_notes: str | None = None,
) -> dict[str, Any]:
    """Quantifies lockup expirations' float impact and price response odds. This function
