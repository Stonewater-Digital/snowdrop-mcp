...
TOOL_META = {
    ...
    "outputSchema": {
        ...
        "properties": {
            ...
            "gst_summary": {
                "type": "object",
                "description": "Structured GST filing packet for downstream automation",
            },
            "status": {"type": "string"},
...
def india_gst_tax_calculator(
    ...
    try:
        ...
        normalized_breakdown = gst_breakdown or {
            "igst": round(gst_amount, 2),
            "cgst": 0.0,
            "sgst": 0.0,
        }
        gst_summary = build_gst_summary(
            normalized_breakdown,
            exemptions=exemptions_applied,
            filings=filing_requirements,
        )
        ...
        audit_entry = record_submission_event(
            "india_gst_tax_calculator",
            "gst_computation",
            status="success",
            payload=result,
            notes=exemptions_applied,
            metadata={
                "service_type": service_type,
                "recipient_location": recipient_location,
                "is_oidar": is_oidar,
